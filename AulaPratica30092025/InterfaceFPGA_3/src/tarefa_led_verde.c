...
// Correção de mapeamento: G=12, B=11
#define GPIO_LED_R   13   // R
#define GPIO_LED_G   12   // G  (trocado)
#define GPIO_LED_B   11   // B  (trocado)

// Seu hardware acende em nível alto (ativo-alto / comum-cátodo)
#define LED_ACTIVE_LOW   0   // use 1 se for comum-ânodo (0 acende)

// Período do pisca (verde on/off)
#define ON_MS   250u
#define OFF_MS  250u
...
// ======== TAREFA: piscar VERDE (apagado ⇄ verde) ========
