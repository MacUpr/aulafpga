...
static void desenhar_cabecalhos_saidas(void)
{
    ...
    ssd1306_draw_utf8_multiline(buf, 0, 0*8, "RESET:", w_pix, h_pix);
    ssd1306_draw_utf8_multiline(buf, 70,0*8, bit_txt(outA), w_pix, h_pix);

    ssd1306_draw_utf8_multiline(buf, 0, 2*8, "UP/DOWN:", w_pix, h_pix);
    ssd1306_draw_utf8_multiline(buf, 70,2*8, bit_txt(outB), w_pix, h_pix);

    ssd1306_draw_utf8_multiline(buf, 0, 4*8, "PAUSE:", w_pix, h_pix);
    ssd1306_draw_utf8_multiline(buf, 70,4*8, bit_txt(outJ), w_pix, h_pix);
